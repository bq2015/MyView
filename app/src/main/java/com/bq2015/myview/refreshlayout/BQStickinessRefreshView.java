 ...
 * 描述:黏性下拉刷新控件
 */
public class BQStickinessRefreshView extends View {
    private static final String TAG = BQStickinessRefreshView.class.getSimpleName();
    private BQStickinessRefreshViewHolder mStickinessRefreshViewHolder;
    ...
    public BQStickinessRefreshView(Context context) {
        this(context, null);
    }

    public BQStickinessRefreshView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BQStickinessRefreshView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initSize() {
        mEdge = BQRefreshLayout.dp2px(getContext(), 5);
        mRotateDrawableSize = BQRefreshLayout.dp2px(getContext(), 30);
...
//            mPath.quadTo(mTopBound.left + mTopSize / 8, mTopBound.bottom, mTopBound.left, mTopBound.bottom - mTopSize / 2);
    ...
    public void setStickinessRefreshViewHolder(BQStickinessRefreshViewHolder stickinessRefreshViewHolder) {
