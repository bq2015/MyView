...
public class BQRefreshScrollingUtil {

    private BQRefreshScrollingUtil() {
    }
    ...
    public static boolean isStickyNavLayoutToTop(BQStickyNavLayout stickyNavLayout) {
    ...
    public static boolean isAbsListViewToBottom(AbsListView absListView) {
        if (absListView != null && absListView.getAdapter() != null && absListView.getChildCount() > 0 && absListView.getLastVisiblePosition() == absListView.getAdapter().getCount() - 1) {
            ...
            BQStickyNavLayout stickyNavLayout = getStickyNavLayout(absListView);
        ...
        if (recyclerView != null) {
            ...
            if (manager instanceof LinearLayoutManager) {
                ...
                if (layoutManager.findLastCompletelyVisibleItemPosition() == layoutManager.getItemCount() - 1) {
                    BQStickyNavLayout stickyNavLayout = getStickyNavLayout(recyclerView);
                    if (stickyNavLayout != null) {
    ...
    public static BQStickyNavLayout getStickyNavLayout(View view) {
        ViewParent viewParent = view.getParent();
        while (viewParent != null) {
            if (viewParent instanceof BQStickyNavLayout) {
                return (BQStickyNavLayout) viewParent;
            }
