...
/**
 * 描述:继承该抽象类实现响应的抽象方法，做出各种下拉刷新效果。参考BQNormalRefreshViewHolder、BQStickinessRefreshViewHolder、BQMoocStyleRefreshViewHolder、BQMeiTuanRefreshViewHolder
 */
public abstract class BQRefreshViewHolder {
    /**
     ...
     * 下拉刷新上拉加载更多控件
     */
    protected BQRefreshLayout mRefreshLayout;
    /**
     * 下拉刷新控件
     */
     ...
     */
    public BQRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
        mContext = context;
